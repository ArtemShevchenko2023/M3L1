...
@app.route("/")
def hello_world():
    return '<h1>Случайный факт о техно-зависимости!</h1> <a href="/random_fact" target=_blank>Посмотреть случайный факт!</a> <p>Как избавиться от прыщей? Смотрите ниже!</p> <a href="/isbavlenie_ot_prishei" target=_blank>Избавилась от прыщей за 2 дня! Как в воду канули!</a>'
...
@app.route("/isbavlenie_ot_prishei")
def nerickroll():
    return '<h1> ВЫ ЗАРИКРОЛЛЕНЫ!!!</h1> <img src=https://c.tenor.com/Ogs53uAnXfoAAAAC/rick-roll.gif> <img src=https://c.tenor.com/Ogs53uAnXfoAAAAC/rick-roll.gif> <img src=https://c.tenor.com/Ogs53uAnXfoAAAAC/rick-roll.gif> <img src=https://c.tenor.com/Ogs53uAnXfoAAAAC/rick-roll.gif>'
app.run(debug=True)